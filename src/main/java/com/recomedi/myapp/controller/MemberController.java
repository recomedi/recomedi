...
//import com.recomedi.myapp.api.MailApi;
import com.recomedi.myapp.controller.MemberController;
...
//	private MailApi mailApi;
	...
	public String memberLoginAction(
		...
		if(mv != null) {
			...
			if(bCryptPasswordEncoder.matches(inputMv.getPwd(), password)) {  // 인코딩 된 부분이 2번째 파라미터
				logger.info("비밀번호 일치");
