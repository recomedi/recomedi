...
<div class="container">
    ...
    <div class="button-group">
        <!-- 다시 시도 버튼 -->
        <button onclick="window.location.href='${pageContext.request.contextPath}/medicine/certification.do'">다시 시도</button>

        <!-- 완료 버튼 -->
        <button onclick="window.location.href='${pageContext.request.contextPath}/medicine/completion.do'">완료</button>
    </div>
