...
$('#refresh-secureNo').on('click', function () {
    $.ajax({
        url: '${pageContext.request.contextPath}/prescription/refreshSecureNo.do',
        method: 'POST',
        success: function (response) {
...
$('#secure-submit').on('click', function () {
    ...
    $.ajax({
        url: '${pageContext.request.contextPath}/prescription/processSecureInput.do',
        method: 'POST',
        data: secureData,
        success: function (response) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.verified) {
                ...
                window.location.href = '${pageContext.request.contextPath}/prescription/prescriptionList.do';
            } else {
