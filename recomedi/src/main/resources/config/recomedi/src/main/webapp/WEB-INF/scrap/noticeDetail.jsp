...
<div class="btnBox">
	<a class="btn aBtn" href="${pageContext.request.contextPath}/notice/noticeModify.do">수정</a>
	<a class="btn aBtn" href="${pageContext.request.contextPath}/notice/noticeDelete.do">삭제</a>
	<a class="btn aBtn" href="${pageContext.request.contextPath}/notice/noticeList.do">목록</a>
</div>
