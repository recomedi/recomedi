...
<form class="search" name="frm" action="${pageContext.request.contextPath}/notice/noticeList.do" method="get">
...
<section>	
	...
	<div class="btnBox">
		<a class="btn aBtn" href="${pageContext.request.contextPath}/notice/noticeWrite.do">글쓰기</a>
	</div>
